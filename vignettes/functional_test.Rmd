...
This script processes recent orbitrap files of each instrument at the [Functional Genomics Center Zurich](https://fgcz.ch/) [proteomics unit](https://fgcz.ch/omics_areas/prot.html) using the latest R development and the [rawR](https://github.com/fgcz/rawR) package version.
