...
vignette: >
  ...
  %\VignetteIndexEntry{The rawrr R package - Direct Access to Orbitrap Data and Beyond}
...
If \code{MONO_PATH} is not set Thermo Fisher Scientific .NET assemblies are
installed in `r rawrr::rawrrAssemblyPath()`.
...
```{r FTP, echo=TRUE, message=FALSE, exec=TRUE}
...
H <- list("Instrument model"=NA, "Number of scans"=NA, "RAW file"=NA, "Time range"=c(NA,NA))
