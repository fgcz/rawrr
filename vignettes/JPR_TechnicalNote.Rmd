...
Our implementation is built on two layers, the `R` and the `C#` layer, which exchange information using file i/o. The following section describes the package topology from top-down, starting with a rationale for the object design.
