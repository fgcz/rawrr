...
* R script "functional test": Extended code example generating an pdf report  using [@MSV000086542] and providing the software environment information: Output of `mono --version` and `sessionInfo()`.
